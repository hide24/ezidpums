class LdapAttributesController < ApplicationController
  ...
  #  @ldap_attribute.destroy
    respond_to do |format|
      format.html { redirect_to ldap_attributes_url, notice: 'Ldap attribute can not be destroyed.' }
  ...
  private
    ...
    def ldap_attribute_params
      params.require(:ldap_attribute).permit(:order, :name, :attribute_filter, :field_type, :enable)
    end
end
